...
slug: cloudy-year-perception-vs-reality
added: 2026-01-02 09:01
updated: 2026-01-02 09:01
tags: [technology, reflection]
excerpt: 'Missing the sun in 2025? I felt the same way. Then I analyzed 227,000 hours of data and discovered my brain had been lying to me all along.'
note: publish
---

![Pixel art illustration of a person looking at weather data on a computer screen while sun shines outside the window](/images/weather-perception-data.png)
...
[![Cloud cover analysis showing yearly averages, cloudy days percentage, monthly comparison, and historical trends](/images/cloud-cover-analysis.png)](/images/cloud-cover-analysis.png)
...
_Want to check your own weather perceptions? Download the [data fetching script](/assets/blog/fetch_cloud_data.py) and [analysis script](/assets/blog/analyze_cloud_cover.py) to replicate this for any city using the free [Open-Meteo Historical Weather API](https://open-meteo.com/)._
