...
- Simple clean design
- Warm color palette with beige/cream background
...
```
Pixel art style 8-bit retro illustration of [IMAGE DESCRIPTION], simple clean design, similar to retro video game graphics
```
